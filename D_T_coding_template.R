...
my_theme_2col = theme(legend.direction = 'horizontal', legend.position = 'top',
                 ...
                 legend.title = element_text(size=16, face='bold'))
## ------------data processing------------------
dt_code = read_table2('/Users/Yun/Documents/bacteria_G4/D_thermus/G4_counts_closest_tss_200_code_7nt_loop.txt')
dt_template = read_table2('/Users/Yun/Documents/bacteria_G4/D_thermus/G4_counts_closest_tss_200_template_7nt_loop.txt')
...
ggplot(dt.code.t, aes(Distance_to_TSS, value)) + geom_boxplot(aes(fill = Order)) +
...
ggsave('boxplot of DT order around TSS_TEMPLATE_coding_sd.svg', path = save_path, scale = 1, width = 7,
       height = 3, units='in')
##-------------------dt,all------------------
